    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-dark-card border border-dark-border rounded-3xl p-8 shadow-2xl shadow-black/50">
          ...
          <div className="bg-dark-card2 border border-dark-border rounded-xl p-4 mb-6 text-sm">
            <p className="text-gray-400 font-medium mb-1">Demo credentials:</p>
            <p className="text-gray-300">Email: <span className="text-airbnb">user@darkbnb.com</span></p>
            <p className="text-gray-300">Password: <span className="text-airbnb">password123</span></p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/auth/register" className="text-airbnb font-semibold hover:underline">
                Sign up
              </Link>
            </p>
          </div>
